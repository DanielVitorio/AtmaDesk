...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("AtmaDesk".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["35.215.216.198"]; //relay pé definido
pub const RS_PUB_KEY: &str = "s3gRIYiyvnSIwqjwQPHBdXZCOow4bhAZkM4O6VJw7xs="; //chave pé definido
