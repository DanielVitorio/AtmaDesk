      ...
      sections: [
        ...
        SettingsSection(title: Text(translate("Settings")), tiles: [
          ...
          SettingsTile(
              ...
              onPressed: (context) {
                showrustdeskSettings(gFFI.dialogManager);
              }),
          SettingsTile(
        ...
        SettingsSection(
          ...
          tiles: [
            ...
            SettingsTile(
              ...
              onPressed: (context) =>
                  launchUrlString('https://AtmaDesk.com/privacy.html'),
...
void showrustdeskSettings(OverlayDialogManager dialogManager) async {
  try {
