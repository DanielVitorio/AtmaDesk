...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do AtmaDesk..."),
        ...
        ("Website", "Website"),
        ("rustdesk-name", "RustDask"),
        ("About", "Sobre"),
        ("Slogan_tip", "AtmaDesk — desenvolvido com base no projeto de código aberto"),
        ...
        ("install_tip", "Devido ao UAC, o AtmaDesk não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o AtmaDesk no sistema."),
        ...
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao AtmaDesk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao AtmaDesk permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o AtmaDesk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [AtmaDesk Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep RustDesk background service", "Manter o serviço do AtmaDesk executando em segundo plano"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do AtmaDesk."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do AtmaDesk."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do AtmaDesk."),
        ...
        ("verify_rustdesk_password_tip", "Verifique a senha do AtmaDesk"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o AtmaDesk e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("upgrade_rustdesk_server_pro_to_{}_tip", "Atualize o AtmaDesk Server Pro para a versão {} ou superior."),
        ("pull_group_failed_tip", "Não foi possível atualizar o grupo."),
        ("Filter by intersection", "Filtrar por interseção"),
        ("Remove wallpaper during incoming sessions", "Remover papel de paredes durante sessão remota"),
        ("Test", "Teste"),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o AtmaDesk funcione corretamente como dispositivo controlado."),
        ...
        ("powered_by_me", "Desenvolvido por AtmaDesk"),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do AtmaDesk estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço AtmaDesk em segundo plano"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente AtmaDesk para a versão {} ou superior no lado remoto."),
