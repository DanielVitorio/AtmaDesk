...
class IconFont {
  ...
  static const IconData rustdesk = IconData(0xe628, fontFamily: _family1);
...
class MyTheme {
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    rustdeskBarTheme: rustdeskBarThemeData(
        style:
            rustdeskStyle(backgroundColor: MaterialStatePropertyAll(Colors.white))),
    colorScheme: ColorScheme.light(
        primary: Colors.blue, secondary: accent, background: grayBg),
    popuprustdeskTheme: PopuprustdeskThemeData(
        color: Colors.white,
        shape: RoundedRectangleBorder(
          side: BorderSide(
...
Future<void> onActiveWindowChanged() async {
  ...
  if (rustdeskWinManager.getActiveWindows().isEmpty) {
    ...
    try {
      ...
      debugPrint("Start closing AtmaDesk...");
    ...
    return Container(
      ...
      child: Obx(() => DropdownButton<String>(
            ...
            onChanged: enabled
                ...
                : null,
            items: values.map<DropdownrustdeskItem<String>>((String value) {
              return DropdownrustdeskItem<String>(
                value: value,
                child: Text(
                  value,
                  style: const TextStyle(fontSize: 15),
...
Widget loadPowered(BuildContext context) {
  return MouseRegion(
    ...
    child: GestureDetector(
      onTap: () {
        launchUrl(Uri.parse('https://AtmaDesk.com'));
      },
      child: Opacity(
          opacity: 0.5,
          child: Text(
